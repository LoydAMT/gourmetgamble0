    ...
    <Router>
      <div>
        <nav style={styles.nav}>
          ...
          {/* Remove the Chat link if the chat is always floating */}
        ...
        <Routes>
          ...
          {/* No longer need a specific route for Chat */}
          {/* Other routes can be defined here */}
        </Routes>

        <div style={styles.contactCard}>
          <button style={styles.footerItem} onClick={() => setShowPrivacyModal(true)}>Privacy Policy</button>
          <button style={styles.footerItem} onClick={() => setShowAboutUsModal(true)}>About Us</button>
          <button style={styles.footerItem}>Feedback</button>
          <button style={styles.footerItem} onClick={() => setShowContactUsModal(true)}>Contact us</button>
        </div>
        ...
        {/* Include the Chat component here so it's available globally across all routes */}
        <Chat />
      </div>
    </Router>
  );
